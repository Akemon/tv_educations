...
public class NumberProviceDao {
    ...
    public List<NumberProvice> countNumberProvince(){
        ...
        List<NumberProvice> p1=sd.countNumberProvice();
        List<NumberProvice> p2=td.countNumberProvice();
        ...
        for(int i=0;i<34;i++){
            NumberProvice np=new NumberProvice(province[i],p1.get(i).getPeopleNumber()+ p2.get(i).getPeopleNumber());
